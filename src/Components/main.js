  ...
  return (
    <div className='w-full'>
      <section className='flex justify-center pt-36 mb-4'>
          <h1 className='text-center text-4xl font-bold leading-[50px] text-white'> - 이재신 - <br /> 프론트엔드 포트폴리오</h1>
      </section>
      <section className='flex justify-center mt-8 mb-6'>
        <div className='w-12 h-1 bg-orange-600'></div>
      </section>
      <section className='flex justify-center my-4'>
        <p className='text-center text-lg tracking-wide text-white'>
      ...
      <section className='flex justify-center mt-12 mb-16'>
        <div className='flex bg-orange-600 px-5 py-2 rounded-3xl cursor-pointer'>
          <Link smooth to='About' className='text-white'>더 알아보기</Link>
          <img src='../../img/Arrow-D.png' alt='' className='ml-1 w-5 h-6'/>
        </div>
      </section>     
    </div>
  );
